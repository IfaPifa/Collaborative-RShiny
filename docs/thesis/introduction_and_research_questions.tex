...
The four research questions form a logical chain:
...
\begin{enumerate}
  ...
  \item \textbf{RQ4} measures \textit{how well} each approach works --- latency, throughput, data loss, cross-contamination across 8 apps. This produces the empirical evidence to answer the central question.
\end{enumerate}

The central research question is answered by the combination of all four: RQ1 and RQ2 provide the theoretical framework, RQ3 provides the engineering contribution, and RQ4 provides the empirical validation.
...
\begin{itemize}[nosep]
  ...
  \item \textbf{RQ3} (bottom-left): REST vs.\ Kafka trade-offs? $\rightarrow$ synchronous vs.\ asynchronous
  \item \textbf{RQ4} (bottom-right): How do they compare? $\rightarrow$ latency, throughput, data loss, cross-contamination
\end{itemize}

\textbf{Visual suggestion:} Colour-code each RQ (e.g., blue, green, orange, red) and use the same colours consistently in later slides.
\end{slidebox}
...
% ============================================================
\section{Slide 8: Research Questions Connection Map}
% ============================================================

\begin{slidebox}{Slide 8: ``How the Research Questions Connect''}
\textbf{Layout:} A horizontal chain of four boxes with arrows between them, all converging into a central box below.
...
``RQ1 and RQ2 provide the theoretical framework. RQ3 provides the engineering contribution. RQ4 provides the empirical validation.''

\textbf{Visual suggestion:} Use the same colour coding from Slide 3. This slide gives the audience a mental map and serves as a transition into the architecture/demo section of the presentation.
\end{slidebox}
